...
describe HomeController do
  ...
  describe '#index' do
    ...
    it 'queries twitter for direct messages with id greater than the max known in db' do
      Message.destroy_all
      FactoryGirl.create(:message, twitter_id: '1234567')
      FactoryGirl.create(:message, twitter_id: '1234')
